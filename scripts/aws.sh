...
# Note: You may need to run this command for specific users: aws iam list-access-keys --user-name <username>
...
echo -e "\n========================================================="
echo "  Extraction Complete. Review the JSON/Table outputs.    "
echo "========================================================="
